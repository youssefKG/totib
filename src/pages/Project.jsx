      ...
      <div className="flex p-2 flex-col relative  ">
        ...
        <div className="flex flex-col p-4">
          ...
          <div className="flex gap-2 justify-center">
            <button className="flex items-center gap-2 mt-4 p-2 px-4 border-white border rounded-lg text-white transitionClass transition-colors font-bold hover:bg-[#e0aaff] hover:text-black">
              <VscLiveShare className="w-5 h-5" />
              <p>Project live</p>
            </button>
            <button className="flex gap-2 items-center  mt-4 p-2  px-4 border-white border rounded-lg text-white transitionClass transition-colors font-bold hover:bg-[#e0aaff] hover:text-black">
