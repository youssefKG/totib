...
const CardProject = ({ info }) => {
  return (
    <Link
      ...
      hover:scale-105 border  border-gray-800 cursor-pointer
      hover:opacity-100 transitionClass bg-[#001242]/40 hover:bg-[#3c096c]/60
    ...
    >
      ...
      <div className=" flex  flex-col gap-4 flex-wrap">
        ...
        <div className="flex gap-2 flex-wrap">
          {info.tec.map((t) => (
            <p className="p-1 px-3 text-gray-300  font-medium bg-[#005e7c005e7o]/70 text-[15px] rounded-full">
              {t}
            </p>
          ))}
        </div>
