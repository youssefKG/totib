...
const Projects = ({ projectsRef }) => {
  return (
    <section
      ref={projectsRef}
      id="projects"
      className="m-6  relative items-center h-screen flex flex-col gap-12"
    >
      <h className=" font-extrabold text-white text-2xl tracking-wider self-start  border-b-[3px]  border-b-[#0094c6] p-2  ">
        Recent Projects :
      </h>
